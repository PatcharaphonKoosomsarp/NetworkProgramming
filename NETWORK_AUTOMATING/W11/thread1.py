...
def ip_is_valid():
    ...
    while True:
        ...
        try:
            ...
            print("*** Fpund Python Traceback Case: --->")
            print("\n*** FIle %s does not exist! Please check and try again!" % ip_file)
        ...
        if check == False:
            ...
            print("\nAll IP addresses in 'ssh-ip.txt' file are valid")
            break
    ...
    while True:
        ...
        if check2 == True:
            print("* Please wait, saving IP address list of device.\n")
            ip_is_valid
...
def user_is_valid():
    ...
    while True:
        print("# # # # # # # # # # # #\n")
        user_file = input("# Enter username file name and extension: ")
        print("# # # # # # # # # # # #\n")

        if os.path.isfile(user_file) == True:
            print("\n* Username file is validated. Waiting for command file...\n")
            break

        else:
            print("\n* ile   %s does not exist! Please check and try again!" % user_file)
            continue
